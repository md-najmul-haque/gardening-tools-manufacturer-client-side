    ...
    return (
        <div>
            ...
            <div data-aos="fade-right" data-aos-easing="linear"
                data-aos-duration="1000" className="hero min-h-fit py-20">

                <div className="hero-content shadow-xl flex-col lg:flex-row">
                    <img src={photo2} className="max-w-xl rounded-lg shadow-2xl" alt='' />

                    <div className='lg: ml-10'>
                        <div className="indicator">
                            <span className="indicator-item badge badge-error bg-red-500 text-white p-3">30% off</span>
                            <div className="grid place-items-center text-3xl  lg:text-4xl font-bold">Hot Deal: Lowest Wholesale Rate</div>
                        </div>
                        <div className='ml-6'>
                            <div>
